...
async function deleteUserData(client, userId, supabaseUserId) {
...
async function deleteSupabaseAuthUser(supabaseUserId) {
    if (!supabaseUrl) {
...
export async function deleteAccount(userId, supabaseUserId) {
